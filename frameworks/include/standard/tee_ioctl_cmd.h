...
#define TC_NS_CLIENT_IOCTL_DSTB_GLOBAL_MSG                _IOWR(TC_NS_CLIENT_IOC_MAGIC, 33, struct DstbMsg)
#define TC_NS_CLIENT_IOCTL_GET_FS_BUFFER_SIZE             _IOWR(TC_NS_CLIENT_IOC_MAGIC, 35, unsigned int)
#endif
