...
enum TEEC_SharedMemCtl {
    ...
    TEEC_MEM_INOUT = 0x3,
    /** The shared memory can carry no copy shared memory data transmitted between CAs and TAs */
    TEEC_MEM_SHARED_INOUT = 0x4,
};
...
enum TEEC_ParamType {
    ...
    /** The parameter is a {@code TEEC_RegisteredMemoryReference} tagged as both input and output. Data is transmitter between a TA and a CA. */
