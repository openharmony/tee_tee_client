...
#include "teeclientreleasesharedmemory_fuzzer.h"
...
namespace OHOS {
    bool TeeClientReleaseSharedMemoryFuzzTest(const uint8_t *data, size_t size)
    {
        bool result = false;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::TeeClientReleaseSharedMemoryFuzzTest(data, size);
    return 0;
}