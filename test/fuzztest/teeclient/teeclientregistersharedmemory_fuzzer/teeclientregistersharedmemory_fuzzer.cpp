...
#include "teeclientregistersharedmemory_fuzzer.h"
...
namespace OHOS {
    bool TeeClientRegisterSharedMemoryFuzzTest(const uint8_t *data, size_t size)
    {
        bool result = false;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::TeeClientRegisterSharedMemoryFuzzTest(data, size);
    return 0;
}